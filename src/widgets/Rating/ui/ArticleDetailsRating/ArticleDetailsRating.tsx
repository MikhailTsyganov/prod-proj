...
import {
  useGetRatingByArticleQuery,
  useSetRatingArticleMutation,
} from '../../api/articleDetailsRatingApi';
...
const ArticleDetailsRating = memo((props: IArticleDetailsRatingProps) => {
  ...
  const [setRating, { isLoading: setRatingIsLoad }] =
    useSetRatingArticleMutation();

  const handleSetRateArticle = useCallback(
